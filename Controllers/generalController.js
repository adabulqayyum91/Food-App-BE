...
// Filter
//********************************************************************************
exports.foodfilter = async (req, res) => {
  let response = responseHelper.getDefaultResponse();
  let arr = [];
  var obj = req.body;
...
//********************************************************************************
exports.foodResturantSearch = async (req, res) => {
  let response = responseHelper.getDefaultResponse();
...
//********************************************************************************
exports.foodResturantSearchForSearchBox = async (req, res) => {
  let response = responseHelper.getDefaultResponse();
  let vendorArr = [];
...
//********************************************************************************
exports.foodLocationSearch = async (req, res) => {
  let response = responseHelper.getDefaultResponse();
  let request = req.body;
